...
root_directory = '/mnt/e/dataset/manifest_wav'   
output_tsv = '/home/wilson/projects/X-Codec2/manifests/manifest_debug.txt'  
exclude_folders = ['/mnt/e/dataset/manifest_wav/test-clean']  
