#start conda
#/workspace/xcodec2n/bash activate_conda.sh
...
rm -f /workspace/xcodec2n/outputs/checkpoints_o/*.ckpt
rm -f /workspace/xcodec2n/outputs/checkpoints/*.ckpt
du -ah /workspace/xcodec2n | sort -rh | head -n 20
