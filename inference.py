...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', type=str, default="/mnt/f/PyCharmProjects/X-Codec2/models/epoch=4-step=1400000.ckpt")
    ...
    model_dir = "/mnt/f/PyCharmProjects/X-Codec2/models"
    # semantic_model = Wav2Vec2BertModel.from_pretrained("facebook/w2v-bert-2.0", output_hidden_states=True)
    semantic_model = Wav2Vec2BertModel.from_pretrained(model_dir, output_hidden_states=True)
